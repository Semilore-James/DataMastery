...
--CREATED TABLE FOR CITIES CAUSE THE PM FORCED ME SO HE CAN SEE THE SCHEMA
CREATE TABLE cities (
...
/* CREATING AN ORDER TABLE, REALIZED DRIVERS_ID HAD ADDITIONAL UNKNOWN DRIVERS, 
SO I CREATED A STAGING TABLE FOR ORDERS, ADDED THE REQUIRED DATA TO DRIVERS TABLE,
THEN INSERTED DATA FROM ORDERS STAGING TO ORDERS TABLE.
*/
CREATE TABLE orders (
...
-- CORRECTED ERROR FROM DRIVERS TABLE END -----------------------------------------------------------------
